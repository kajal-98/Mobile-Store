...
?>
<form method="post" action="userHome.php?action=add&id=<?php echo $row["pid"];?>">
<center><div  style="border:1px solid #333;background-color:lightyellow;border-radius:15px;padding:20px;width:75px;
height:200px;float:left;margin-bottom: 0.5em;
	
   padding-top: .6em;
   padding-bottom: .6em;" align="center">
<img src="<?php echo $row["Image"];?>"class="img-res" height="50px" width="50px" align="center"/> 
<h4 class="text-info" height="50px" width="50px" align="center"><?php echo $row["model_name"];?></h4>
<h4 class="text-dnger" height="50px" width="50px" align="center"><?php echo $row["price"];?></h4>	
</div></center>
</form>
